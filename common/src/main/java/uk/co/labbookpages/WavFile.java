...
public class WavFile
{
    ...
    // Cannot instantiate com.lightbend.akkastream.WavFile directly, must either use newWavFile() or openWavFile()
    private WavFile()
    {
    ...
    {
        if (ioState != IOState.READING) throw new IOException("Cannot read from com.lightbend.akkastream.WavFile instance");
    ...
    {
        if (ioState != IOState.WRITING) throw new IOException("Cannot write to com.lightbend.akkastream.WavFile instance");
